...
export const saveSieveAndMagnetNewPlant = async (data: SieveAndMagnetData[]): Promise<SaveResponse> => {
  console.log('saveSieveAndMagnetNewPlant called with data:', data);
