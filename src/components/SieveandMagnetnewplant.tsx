...
import { saveSieveAndMagnetNewPlant, collectEstimationDataCycleSave, fetchCycleData } from '../Services/saveSieveAndMagnetNewPlant';
import {
  setCompletedCycles,
  addCompletedCycle,
  addPendingSync,
...
const SieveandMagnetnewplant: React.FC = () => {
    console.log('SieveandMagnetnewplant component is rendering...');
    ...
    } = useSelector((state: RootState) => state.sieveAndMagnetNewPlant);
    ...
    // Checklist items state - New Plant structure (21 items)
    const [checklistItems, setChecklistItems] = useState<ChecklistItem[]>([
            { id: 'sugar-sifter', label: 'Sugar Sifter', status: null, remarks: '' },
            { id: 'maida-sifter-sieve-double-decker-l-5-7', label: 'Maida Sifter Sieve Double Decker L-5&7', status: null, remarks: '' },
            { id: 'maida-sifter-sieve-double-decker-l-6', label: 'Maida Sifter Sieve Double Decker L-6', status: null, remarks: '' },
            { id: 'biscuits-dust-1-l-5-7', label: 'Biscuits Dust 1 (L-5&7)', status: null, remarks: '' },
            { id: 'biscuits-dust-2-l-6', label: 'Biscuits Dust 2 (L-6)', status: null, remarks: '' },
            { id: 'chemical-sifter-1', label: 'Chemical Sifter 1', status: null, remarks: '' },
            { id: 'chemical-sifter-2', label: 'Chemical Sifter 2', status: null, remarks: '' },
            { id: 'chemical-sifter-3-cocoa-powder', label: 'Chemical Sifter 3 (Cocoa powder)', status: null, remarks: '' },
            { id: 'chemical-sifter-4-smp', label: 'Chemical Sifter 4 (SMP)', status: null, remarks: '' },
            { id: 'invert-syrup-bucket-filter', label: 'Invert Syrup - Bucket Filter', status: null, remarks: '' },
            { id: 'black-jack-bucket-filter', label: 'Black jack - Bucket Filter', status: null, remarks: '' },
            { id: 'sugar-grinding-room', label: 'Sugar Grinding Room', status: null, remarks: '' },
            { id: 'packing-temp-l-5', label: 'Packing Temp L-5', status: null, remarks: '' },
            { id: 'packing-temp-l-6', label: 'Packing Temp L-6', status: null, remarks: '' },
            { id: 'packing-temp-l-7', label: 'Packing Temp L-7', status: null, remarks: '' },
            { id: 'l-5-cooling-tunnel-temp-zone-1', label: 'L-5 Cooling tunnel temp. Zone-1', status: null, remarks: '' },
            { id: 'l-5-cooling-tunnel-temp-zone-2', label: 'L-5 Cooling tunnel temp. Zone-2', status: null, remarks: '' },
            { id: 'l-5-cooling-tunnel-temp-zone-3', label: 'L-5 Cooling tunnel temp. Zone-3', status: null, remarks: '' },
            { id: 'cold-storage-1', label: 'Cold Storage-1', status: null, remarks: '' },
            { id: 'cold-storage-2', label: 'Cold Storage-2', status: null, remarks: '' },
            { id: 'flavour-room', label: 'Flavour Room', status: null, remarks: '' }
          ]);
        ...
        return (
            <DashboardLayout>
                ...
                <div className="bg-gray-100 px-3 sm:px-4 md:px-6 py-3 sm:py-4 mb-4 sm:mb-6 rounded-lg w-full">
                            ...
                            <h1 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">Critical Points(CP) Verification & Monitoring Record (Sieve, Magnet, Rh and Temperature) New Plant
                            </h1>
...
export default SieveandMagnetnewplant;
